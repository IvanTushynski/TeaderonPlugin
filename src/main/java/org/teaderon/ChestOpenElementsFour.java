...
public class ChestOpenElementsFour implements CommandExecutor {

    public ChestOpenElementsFour() {
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if (check >= 0 && check <= 20) {
                ...
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 9 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
            } else if (check >= 21 && check <= 30) {
                this.executeCommand5(player, true, "mi give GEM_STONE ARMORFIREELEMENT10 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 10 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
            } else if (check >= 31 && check <= 40) {
                this.executeCommand5(player, true, "mi give GEM_STONE ARMORFIREELEMENT11 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 11 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
            } else if (check >= 41 && check <= 50) {
                this.executeCommand5(player, true, "mi give GEM_STONE ARMORICEELEMENT9 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 9 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
                ...
                this.executeCommand5(player, true, "mi give GEM_STONE ARMORICEELEMENT11 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 11 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
            } else if (check >= 71 && check <= 80) {
                this.executeCommand5(player, true, "mi give GEM_STONE ARMOREARTHELEMENT9 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 9 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
                ...
                this.executeCommand5(player, true, "mi give GEM_STONE ARMOREARTHELEMENT11 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 11 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
            } else if (check >= 101 && check <= 110) {
                this.executeCommand5(player, true, "mi give GEM_STONE ARMORWINDELEMENT9 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 9 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
                ...
                this.executeCommand5(player, true, "mi give GEM_STONE ARMORWINDELEMENT11 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 11 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
            } else if (check >= 131 && check <= 140) {
                this.executeCommand5(player, true, "mi give GEM_STONE ARMORLIGHTNESSELEMENT9 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 9 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
                ...
                this.executeCommand5(player, true, "mi give GEM_STONE ARMORLIGHTNESSELEMENT11 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 11 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
            } else if (check >= 161 && check <= 170) {
                this.executeCommand5(player, true, "mi give GEM_STONE ARMORDARKNESSELEMENT9 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 9 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
                ...
                this.executeCommand5(player, true, "mi give GEM_STONE ARMORDARKNESSELEMENT11 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 11 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
                ...
                this.executeCommand5(player, true, "mi give GEM_STONE FIREELEMENT9 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 9 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
                ...
                this.executeCommand5(player, true, "mi give GEM_STONE FIREELEMENT11 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 11 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
            } else if (check >= 251 && check <= 260) {
                this.executeCommand5(player, true, "mi give GEM_STONE ICEELEMENT9 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 9 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
                ...
                this.executeCommand5(player, true, "mi give GEM_STONE ICEELEMENT11 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 11 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
            } else if (check >= 281 && check <= 290) {
                this.executeCommand5(player, true, "mi give GEM_STONE EARTHELEMENT9 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 9 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
                ...
                this.executeCommand5(player, true, "mi give GEM_STONE EARTHELEMENT11 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 11 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
            } else if (check >= 311 && check <= 320) {
                this.executeCommand5(player, true, "mi give GEM_STONE WINDELEMENT9 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 9 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
                ...
                this.executeCommand5(player, true, "mi give GEM_STONE WINDELEMENT11 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 11 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
            } else if (check >= 341 && check <= 350) {
                this.executeCommand5(player, true, "mi give GEM_STONE LIGHTNESSELEMENT9 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 9 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
                ...
                this.executeCommand5(player, true, "mi give GEM_STONE LIGHTNESSELEMENT11 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 11 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
            } else if (check >= 371 && check <= 380) {
                this.executeCommand5(player, true, "mi give GEM_STONE DARKNESSELEMENT9 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 9 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
                ...
                this.executeCommand5(player, true, "mi give GEM_STONE DARKNESSELEMENT11 %player% 1");
                player.playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.0F, 1.0F);
                player.sendTitle(ChatColor.GOLD + "Стихийный Самоцвет 11 Уровня!", ChatColor.RED + "Поздравляем", 2, 30, 2);
